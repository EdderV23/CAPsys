 ...
 * @author Edder
 */
public class CitasAdultoVistaDirector extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasAdultoVistaDirector() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasAdultoVistaDirector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasAdultoVistaDirector().setVisible(true);
            }
        });
    }
