 ...
 * @author Edder
 */
public class CitasAdultoVistaPsicologo extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasAdultoVistaPsicologo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasAdultoVistaPsicologo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasAdultoVistaPsicologo().setVisible(true);
            }
        });
    }
