 ...
 * @author Edder
 */
public class CitasNiñosVistaSecretaria extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasNiñosVistaSecretaria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cronograma Niños");
        ...
        tablita.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombres del Paciente", "Apellidos del Paciente", "ID del Paciente", "Nombres del Especialista", "Apellidos del Especialista", "Cédula del Especialista", "Fecha de la Cita"
            }
        ) {
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        if(cadena1.equals("")){
            ...
            while(rs.next()){
                dato[0] = rs.getString("NombresNiños");
                dato[1] = rs.getString("ApellidosNiños");
                dato[2] = rs.getString("IndiceNiños");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasNiñosVistaSecretaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasNiñosVistaSecretaria().setVisible(true);
            }
        });
    }
