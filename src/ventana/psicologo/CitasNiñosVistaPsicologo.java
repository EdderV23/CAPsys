 ...
 * @author Edder
 */
public class CitasNiñosVistaPsicologo extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasNiñosVistaPsicologo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasNiñosVistaPsicologo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasNiñosVistaPsicologo().setVisible(true);
            }
        });
    }
