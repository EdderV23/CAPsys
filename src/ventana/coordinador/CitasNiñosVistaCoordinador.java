 ...
 * @author Edder
 */
public class CitasNiñosVistaCoordinador extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasNiñosVistaCoordinador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasNiñosVistaCoordinador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasNiñosVistaCoordinador().setVisible(true);
            }
        });
    }
