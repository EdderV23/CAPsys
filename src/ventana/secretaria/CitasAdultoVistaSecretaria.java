 ...
 * @author Edder
 */
public class CitasAdultoVistaSecretaria extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasAdultoVistaSecretaria() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasAdultoVistaSecretaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasAdultoVistaSecretaria().setVisible(true);
            }
        });
    }
