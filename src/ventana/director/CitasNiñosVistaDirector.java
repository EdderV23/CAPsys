 ...
 * @author Edder
 */
public class CitasNiñosVistaDirector extends javax.swing.JFrame {

    /** Creates new form CitasAdultoVista */
    public CitasNiñosVistaDirector() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasNiñosVistaDirector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CitasNiñosVistaDirector().setVisible(true);
            }
        });
    }
